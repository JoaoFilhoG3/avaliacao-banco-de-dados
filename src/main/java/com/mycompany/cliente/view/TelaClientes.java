...
import com.mycompany.cliente.model.DAO.ClienteDAO;
...
public class TelaClientes extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtIdade, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Cliente cli = new Cliente(0, nome, endereco, email, cpf, idade);
    ...
    public void preencheTabela(){
        ...
        String colunas[] = new String[]{"Cód.","Nome","Endereço","Email","CPF","Idade"};
        DefaultTableModel tbmClientes = new DefaultTableModel(colunas, 0);
        for (int i = 0; i < lClientes.size(); i++) {
            Cliente cli = lClientes.get(i);
            tbmClientes.addRow(new Object[]{
                cli.getCodCli(),
                cli.getNome(),
                cli.getEndereco(),
                cli.getEmail(),
        ...
        tblClientes.setModel(tbmClientes);
    }
}
